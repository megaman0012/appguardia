...
const styles = StyleSheet.create({
  ...
  tabBtn: { flex: 1, paddingVertical: 10, alignItems: 'center', backgroundColor: COLORES.fondo },
  tabOn: { backgroundColor: COLORES.marca },
  tabText: { color: COLORES.marca, fontWeight: '600' },
  tabTextOn: { color: COLORES.textoSobreMarca, fontWeight: '600' },
  dateRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  tipoChipText: { color: COLORES.texto, fontSize: 13 },
  tipoChipTextOn: { color: COLORES.textoSobreMarca, fontWeight: '600', fontSize: 13 },
  newButton: {
  ...
  itemName: { fontSize: 15, fontWeight: '600', color: COLORES.texto, flex: 1, marginRight: 8 },
  badgesRow: { flexDirection: 'row', alignItems: 'center' },
  badge: { borderRadius: 10, paddingHorizontal: 8, paddingVertical: 3, marginLeft: 6 },
  badgeEntrada: { backgroundColor: COLORES.exitoSuave },
  badgeSalida: { backgroundColor: COLORES.criticoSuave },
  badgeCurso: { backgroundColor: COLORES.informacionSuave },
  badgeCompletada: { backgroundColor: COLORES.neutroSuave },
  badgePendiente: { backgroundColor: COLORES.advertenciaSuave },
  badgeLlego: { backgroundColor: COLORES.exitoSuave },
  badgeCancelado: { backgroundColor: COLORES.criticoSuave },
  badgeText: { fontSize: 11, fontWeight: '700', color: COLORES.texto },
  itemDetail: { fontSize: 14, color: COLORES.textoSuave, marginTop: 4 },
  itemPermanencia: { fontSize: 14, color: COLORES.advertencia, marginTop: 4, fontWeight: '600' },
  itemDate: { fontSize: 13, color: COLORES.marca, marginTop: 6, fontWeight: '600' },
  ...
  cancelButton: { backgroundColor: COLORES.critico },
  salidaButtonText: { color: COLORES.textoSobreMarca, fontWeight: '600' },
